...
export default {
    ...
    async function(interaction) {
        const userId = getOption(interaction, "user") ?? interaction.user?.id ?? interaction.member?.id;
        const useServer = getOption(interaction, "server") ?? false;
        // Fetch the full user object so we have avatar hash
