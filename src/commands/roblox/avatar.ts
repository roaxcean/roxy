...
import { resolveUser, getAvatarUrl, RobloxError, AvatarType } from "./_api.js";

const TYPE_MAP: Record<string, { type: AvatarType; size: string; label: string }> = {
...
export default {
    ...
    async function(interaction: CommandInteraction) {
        ...
        const typeKey  = getOption<string>(interaction, "type") ?? "full";
