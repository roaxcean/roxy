...
export default {
    ...
    async function(interaction) {
        ...
        // Fetch friends count, followers, followings, groups in parallel — best effort
        const [friendsData, followersData, followingsData, groupsData, avatarUrl] = await Promise.allSettled([
            rbx(`https://friends.roblox.com/v1/users/${user.id}/friends/count`),
            rbx(`https://friends.roblox.com/v1/users/${user.id}/followers/count`),
            rbx(`https://friends.roblox.com/v1/users/${user.id}/followings/count`),
            rbx(`https://groups.roblox.com/v1/users/${user.id}/groups/roles?includeLocked=false`),
